...
## Product UI
After creating a run, tell the user to open https://agentclash.dev, sign in, and find run ID `<RUN_ID>` in their workspace runs list for live events and scorecards.

## Related Skills
- `agentclash-hub` — workflow map and UI links
...
## Related Docs
- https://agentclash.dev/docs/getting-started/first-eval
- https://agentclash.dev/docs/concepts/runs-and-evals
- https://agentclash.dev/docs/concepts/replay-and-scorecards
